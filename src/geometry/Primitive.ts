...
export class Primitive{
    ...
    constructor(public vertices: IndexFloatArray, origin:number) {
        this.p0.set(vertices.get(origin + 0), vertices.get(origin + 1), vertices.get(origin + 2));
        this.p1.set(vertices.get(origin + 3), vertices.get(origin + 4), vertices.get(origin + 5));
        this.p2.set(vertices.get(origin + 6), vertices.get(origin + 7), vertices.get(origin + 8));
        this.n.set(vertices.get(origin + 9), vertices.get(origin + 10), vertices.get(origin + 11));
