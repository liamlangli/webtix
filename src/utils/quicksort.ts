 ...
 **/
export function InsertionSort(arr: any, from: number, to: number, compareFunction: Function) {
...
export function QuickSort(a: any, from: number, to: number, compareFunction: Function) {
  var third_index = 0;
  while (true) {
