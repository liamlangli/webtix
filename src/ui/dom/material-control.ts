...
function create_slider_component(
    name: string,
    value: number,
    onValueChanged?: OnValueChanged,
    options: ValueOptions = new ValueOptions(),
): HTMLDivElement {
...
function create_color_control(
    ...
    const slider_r = create_slider_component("R", color.x, (value: number) => {
        color.x = value;
    });
    const slider_g = create_slider_component("G", color.y, (value: number) => {
        color.y = value;
    });
    const slider_b = create_slider_component("B", color.z, (value: number) => {
        color.z = value;
    });
...
function create_value_control(
    ...
    const slider = create_slider_component(
        name,
        value,
        onValueChanged,
        options,
...
export class MaterialControl {
    ...
    control(material: Material): void {
        this.container.appendChild(
            create_color_control("albedo", material.emission),
        );
        this.container.appendChild(
        ...
        this.container.appendChild(
            create_color_control("emission", material.emission),
        );
        this.container.appendChild(
            create_value_control(
                "transmission",
        ...
        this.container.appendChild(
            create_color_control("absorption", material.absorption),
        );
    }
